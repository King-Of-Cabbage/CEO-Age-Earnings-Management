...
The baseline AEM row should be read as a positive association with the AEM measure used in the analysis; the repository does not assign a monetary unit to that measure.
