...
def run(config):
    ...
    save_continuous_age_plot(out / "reproduced_primary_results.csv", "AEM_w", figs / "aem_coefficients.png", "CEO_age_w coefficients for AEM models", 1_000_000, "Coefficient per one-year increase, RMB million")
    ...
    save_age_band_plot(out / "reproduced_primary_results.csv", "AEM_w", figs / "aem_age_band_robustness.png", "AEM age-band differences relative to CEOs below 45", 1_000_000, "Coefficient difference, RMB million")
    ...
    save_covariance_plot(out / "reproduced_sensitivity_results.csv", "AEM_w", figs / "covariance_sensitivity_aem.png", "Baseline AEM covariance sensitivity", 1_000_000, "Coefficient per one-year increase, RMB million")
